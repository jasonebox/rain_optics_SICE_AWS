...
if os.getlogin() == 'adrien':
    CLIENT_ID='eb2052e3-23c9-49d5-9da4-05bbe71e333b'
    CLIENT_SECRET=',NpaHPOia%<h-fP{{M/B<kdg2:!%I;t[hs1>|BM1'
    data_folder='/home/adrien/Downloads/'
...
station_info =  pd.read_csv('/home/adrien/EO-IO/rain_optics_SICE_AWS/AWS_info/PROMICE_GC-Net_info.csv')
...
dates=['2021-08-10','2021-08-11','2021-08-12','2021-08-09','2021-08-08','2021-08-07','2021-08-06','2021-08-05']
